...
import { GameContext, GameProvider, useGameState } from "../../../context/GameContext";
...
export const GameContainer: React.FC = () => {
    ...
    }, [currentGame, engine, updatePlayer]);
    ...
    return (
        <>
            ...
            {currentGame && username && <GameCanvas game={currentGame} playerName={username}/>}
